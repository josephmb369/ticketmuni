          ...
          <div class="panel-body">
            ...
            <label><span class=""></span>INFORMACIÓN DEL CONTACTO</label>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nombre_usuario" placeholder="Escribe tu nombre de usuario" title="Solo es validos letras y numeros no caracteres especiales" maxlength="20" pattern="[a-zA-Z0-9 ]{1,30}" required/>
              </div>
              <div class="form-group">
